...
st.markdown("""
    <div style="text-align: center; padding: 40px 20px; margin: -20px -20px 0 -20px; 
                ...
                border-bottom: none;">
        <h1 style="font-size: 3em; margin: 0; color: #cbd5e0 !important;">
            🕷️ <span style="color: #cbd5e0 !important; font-weight: 800;">Honeypot Intelligence Platform</span>
        </h1>
...
with st.sidebar:
    ...
    <div style="background: #ffffff; 
        ...
        <h3 style="color: #000000; margin-top: 0; font-size: 1.2em;">📊 System Dashboard</h3>
    </div>
    """, unsafe_allow_html=True)
