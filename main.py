...
st.markdown("""
    <div style="text-align: center; padding: 40px 20px; margin: -20px -20px 0 -20px; 
                ...
                border-bottom: none;">
        <h1 style="font-size: 3em; margin: 0; color: rgb(255, 255, 255) !important;">
            🕷️ <span style="color: rgb(255, 255, 255) !important; font-weight: 800;">Honeypot Intelligence Platform</span>
        </h1>
